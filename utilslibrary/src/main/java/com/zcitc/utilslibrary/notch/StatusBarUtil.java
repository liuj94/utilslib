...
//                statusBarHeight =  getNotchSizeAtHuawei(activity)[1];
//            }
//        }else  {
...
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//            Window window = activity.getWindow();
////      window.addFlags(WindowManager.PercentLayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
...
//            try {
//                int darkModeFlag = 0;
//                Class layoutParams = Class.forName("android.view.MiuiWindowManager$PercentLayoutParams");
